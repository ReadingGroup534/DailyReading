...
values
('reading123456789000001','诚信是金','玉良清风','sanwen','树无根茎，则无以生。人无诚信，则无以立。为人有信，故能标风立德。居官有信，故能守廉自好。行商有信，故能广业兴家。诚信，何为诚？诚者，无欺也。何为信？信者，守诺也。待人无欺，言出守诺，可谓之诚信。用四个字简单的来说，“一诺千金”，便是对诚信的最好诠释！', 4, 10, 5, 100, '/api/detail.htm?article_id=reading123456789000001');

insert into article
(article_id, title, author, article_type, abstracts, recommend_star, praise_times, share_times, scan_times, url)
values
('reading123456789000002','八月三十一','花毋','sanwen','月半边隐匿在山尖，朦胧在夜色里，窗外桥头有乘凉的人各自欢愉，声音稀疏明朗，八月还未央。', 3, 10, 8, 101, '/api/detail.htm?article_id=reading123456789000002');

insert into article
(article_id, title, author, article_type, abstracts, recommend_star, praise_times, share_times, scan_times, url)
values
('reading123456789000003','婚姻感悟','欣悦','sanwen','关于婚姻的感悟，每个人也许都持有不同的感悟吧。我认为婚姻是性和爱交织在一起的情感生活，有每天的柴米油盐酱醋的需要，还有夹杂生活中各种繁琐事件的面对和解决。性方面或爱情方面还有生活方面出现不协调，婚姻就会出现裂缝，有的出现破裂。', 4, 10, 8, 105, '/api/detail.htm?article_id=reading123456789000003');

insert into article
(article_id, title, author, article_type, abstracts, recommend_star, praise_times, share_times, scan_times, url)
values
('reading123456789000004','只为守护心中的那一抹绿色','紫树','sanwen','我没有想到我的青春会与你有关，也没有想到你会充满我的现在或许以后的人生。来到这里，不为赢得鲜花入怀陪伴，只为守护心中的那一抹绿色', 3, 15, 8, 199, '/api/detail.htm?article_id=reading123456789000004');

insert into article
(article_id, title, author, article_type, abstracts, recommend_star, praise_times, share_times, scan_times, url)
values
('reading123456789000005','村头那两颗爱情树','禹微言','sanwen','随着年岁增长，儿时的记忆大多模糊了去，而深印心中的一些美好，却如昨日花香，时袅身旁。', 3, 32, 8, 101, '/api/detail.htm?article_id=reading123456789000005');
